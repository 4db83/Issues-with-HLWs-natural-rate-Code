function [xh,fh,retcodeh,itct,gh,H,fcount] = csminwel(fcn,x0,H0,grad,crit,nit,varargin)
%        [X,FVAL,EXITFLAG,OUTPUT,GRAD,HESSIAN] = fminunc
% NOTE THAT I HAVE CHANGED THIS AROUND SO THAT IT RETUNS MORE OR LESS IN SAME ORDER AS
% FMINCUNC AND FMINCON.
...
% DIR WHERE TO STORE THE GRADIENT AND HESSIAN, Hessian is written in bfgsi.m file
dir_store = './_csminwel_output/';

if ~exist(dir_store,'dir')
	mkdir(dir_store) 
end
...
%       disp([sprintf('x = ') sprintf('%15.8g %15.8g %15.8g %15.8g\n',x)]);
   ...
   if retcode1 ~= 1
      if retcode1==2 | retcode1==4
         ...
         % save g1 g1 x1 f1 varargin;
				 save([dir_store 'g1.mat'], 'g1', 'x1', 'f1', 'varargin');
         % ARGLIST
         ...
         if  f2 < f
            if retcode2==2 | retcode2==4
               ...
               % save g2 g2 x2 f2 varargin
							 save([dir_store 'g2.mat'], 'g2', 'x2', 'f2', 'varargin');
               % ARGLIST
               ...
               if norm(x2-x1) < 1e-13
                  ...
                  if retcode3==2 | retcode3==4
                     ...
                     % save g3 g3 x3 f3 varargin;
										 save([dir_store 'g3.mat'], 'g3', 'x3', 'f3', 'varargin');
                     % ARGLIST
   ...
   stuck = (abs(fh-f) < crit);
   if (~badg)&(~badgh)&(~stuck)
      H = bfgsi(H,gh-g,xh-x,PRINT_ITERS_);
   end
   if Verbose
%       disp('----')
			if PRINT_ITERS_ 
